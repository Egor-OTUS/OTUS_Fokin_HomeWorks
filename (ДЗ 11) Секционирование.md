...
Сравним количество строк таблиц, чтобы убедиться, что мы ничего не потеряли  
<img width="396" height="218" alt="image" src="https://github.com/user-attachments/assets/f403988d-b070-459b-ad3f-0c13fb6b9fb6" />

Проверим несколько секций, чтобы убедиться, что данные попали именно в свои диапазоны  
...
Повторное применение explain после индексов, видим, что теперь мы ускорили скорость выполения запроса  
...
Проверяем есть ли значение 99999 в таблице tickets1     
*SELECT * FROM bookings.tickets1 WHERE book_ref = '999999';*  
<img width="534" height="75" alt="image" src="https://github.com/user-attachments/assets/b8490d31-c55f-4716-8f9d-4a5ea7442178" />

INSERT выполняется  
<img width="1288" height="33" alt="image" src="https://github.com/user-attachments/assets/1f4f274d-6ad2-4ac1-aaf2-291607430a34" />

Запись должна появиться в секции bookings.tickets1_part_digits, проверяем, INSERT работает  
<img width="608" height="85" alt="image" src="https://github.com/user-attachments/assets/04626cc4-dbe8-4c44-ac8e-8ce54a767c18" />

UPDATE выполняется  
<img width="704" height="229" alt="image" src="https://github.com/user-attachments/assets/454a073a-d978-4572-ae4e-7ed80f31cef6" />

DELETE выполняется  
<img width="608" height="233" alt="image" src="https://github.com/user-attachments/assets/e1ca7c4d-7597-4807-b25c-38a5477391fd" />
